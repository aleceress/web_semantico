...
\begin{minipage}{\linewidth}
	\centering
      \includegraphics[width=0.8\linewidth]{crispFuzzifier.png}
...
\begin{minipage}{\linewidth}
	\centering
      \includegraphics[width=0.8\linewidth]{linearFuzzifier.png}
...
\begin{minipage}{\linewidth}
       \includegraphics[width=0.8\linewidth]{exponentialFuzzifier.png}
	 \captionof{figure}{Grafico esemplificativo di un exponential fuzzifier con $\alpha$ = 0.001}
\end{minipage}

\begin{minipage}{\linewidth}
       \includegraphics[width=0.8\linewidth]{exponentialFuzzifier2.png}
...
\begin{minipage}{\linewidth}
       \includegraphics[width=0.8\linewidth]{quantileConstantPiecewiseFuzzifier.png}
...
\begin{minipage}{\linewidth}
       \includegraphics[width=0.8\linewidth]{quantileLinearPiecewiseFuzzifier.png}
