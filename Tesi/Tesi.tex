...
Nel caso di un insieme fuzzy, la funzione di appartenenza si presenta nella generalizzazione  $f: X \mapsto [0,1]$ : invece di un valore booleano, restituisce un numero continuo nell'intervallo tra 0 e 1, che sta ad indicare il grado di appartenenza all'insieme.
